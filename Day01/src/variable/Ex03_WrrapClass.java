...
public class Ex03_WrrapClass {

	public static void main(String[] args) {
		
		// Wrraper Class : 비 객체형 primitive type의 데이터를 객체형 데이터로 처리하기 위한 자료형
		// primitive type과 1:1대응되면, 클래스 이므로 첫글자는 대문자 처리한다
		...
		// 같은 정수라고 해도, byte와 short는 호환되지 않는다
		Byte by3 = 12;
...
//		Short sh3 = (Short)by3;	// Cannot cast from Byte to Short
		...
		Short sh32 = (short)(byte)by3;	// 변수 이름에 가까운 형변환부터 수행된다
